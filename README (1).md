...
### Customer Management Service — an AI-powered, microservice-backed CRM platform for BrewCo, a coffee brand — customer segmentation, churn prediction, RFM clustering, natural-language analytics, and AI-assisted campaigns, all behind JWT-secured REST APIs.
...
![Live](https://img.shields.io/badge/Live%20Demo-Online-22c55e?style=for-the-badge&logo=vercel&logoColor=white)
...
cd brewco-crm   # repo folder — the product itself is BrewFlow
```
...
**Dashboard — Overview**
KPIs at a glance (customers, orders, revenue, campaigns) plus the "Ask Your Data" NL-to-SQL bar.
![Dashboard Overview](screenshots/dashboard-overview.png)

**Dashboard — Campaign Funnel & Top Customers**
Sent → Delivered → Opened → Clicked funnel with conversion rates, and a ranked VIP customer leaderboard.
![Dashboard Funnel](screenshots/dashboard-funnel.png)

**Dashboard — Customers by City & Revenue Trend**
Geographic distribution of the customer base and the 30-day revenue chart.
![Dashboard Analytics](screenshots/dashboard-analytics.png)

**Customers**
Searchable customer directory with health status (VIP / Active / At Risk) driven by the churn model.
![Customers](screenshots/customers.png)

**Campaigns**
Campaign history table alongside the create-campaign panel with segment and channel selection.
